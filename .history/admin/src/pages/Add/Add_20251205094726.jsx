...
const Add = ({ url }) => {
  ...
  const [data, setData] = useState({
    ...
    description: '',
    price: '',
    category: 'Salads' // Changed default to match menu_list
  });
  const [loading, setLoading] = useState(false);
    ...
    try {
      ...
      if (response.data.success) {
        setData({
          ...
          description: '',
          price: '',
          category: 'Salads' // Reset to default
        });
        setImage(null);
        ...
        <div className="add-category-price">
          <div className="add-category flex-col">
            ...
            <select 
              ...
              disabled={loading}
            >
              {/* Updated options to match menu_list from assets.js */}
              <option value="Salads">Salads</option>
              <option value="Biryanis and Rolls">Biryanis and Rolls</option>
              <option value="Special Dishes">Special Dishes</option>
              <option value="Maharashtrian Dishes">Maharashtrian Dishes</option>
              <option value="Veg Dishes and Thalis">Veg Dishes and Thalis</option>
              <option value="Non-Veg Dishes and Thalis">Non-Veg Dishes and Thalis</option>
