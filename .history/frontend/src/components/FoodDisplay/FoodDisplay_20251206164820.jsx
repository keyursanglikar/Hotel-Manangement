...
//       console.log("Total food items:", food_list.length);
//     }
//   }, [food_list]);

//   // Extract all unique categories from food list and filter foods
//   useEffect(() => {
//     if (food_list && food_list.length > 0) {
//       // Get unique categories
//       const categories = [...new Set(food_list
...
const FoodDisplay = ({ category }) => {
  ...
  return (
    <div className='food-display' id='food-display'>
      <div className="food-display-header">
        <h3>{category === "All" ? "All Dishes" : `${category} Dishes`}</h3>
        <div className="category-counter">
          <span>{filteredFoods.length} items</span>
        </div>
      </div>
